...
#ifndef DATABASE_TABLES_NODECOMMENT_H
#define DATABASE_TABLES_NODECOMMENT_H
...
public:
    NodeComment();
    NodeComment(const DataTypes::Integer &id,
    ...
    static NodeComment fromRecord(const QSqlRecord &record, bool *ok = NULL);
...
#endif // DATABASE_TABLES_NODECOMMENT_H
